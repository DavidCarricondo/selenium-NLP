...
from src.model_utils import encoder, prediction


#Function to get the predictions:
def sample_predict(sample_pred_text, model, tokenizer):
    '''
    Get the prediction of the sample from the model after preprocessing
    '''
    predict = []
    for k, v in sample_pred_text.items():
        encoded_review = encoder(tokenizer, v)
        pred = prediction(encoded_review, model=model)
        predict.extend(pred)
    return predict
